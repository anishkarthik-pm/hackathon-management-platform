...
import { ArrowLeft, ArrowRight, Gavel, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="w-full max-w-md">
          <Card className="bg-navy-secondary border-white/10 rounded-3xl p-8 card-shadow">
            ...
            <p className="text-text-secondary text-center mb-8">
              Sign in to review submissions and score projects
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="h-12 bg-navy-primary border-white/10 text-white placeholder:text-text-secondary/50 focus:border-purple-500"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input 
                    ...
                    className="h-12 bg-navy-primary border-white/10 text-white placeholder:text-text-secondary/50 focus:border-purple-500 pr-10"
                    required
                  />
                  <button
                    type="button"
              ...
              <Button 
                type="submit"
                className="w-full h-12 bg-purple-500 text-white hover:bg-purple-600 font-display font-bold text-lg rounded-xl"
              >
                Login as Judge <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </form>
            ...
            <div className="mt-6 p-4 bg-purple-500/10 rounded-xl">
              <p className="text-purple-500 text-sm text-center">
                ...
                Email: judge@glhackathon.com<br />
                Password: judge123
              </p>
            </div>
